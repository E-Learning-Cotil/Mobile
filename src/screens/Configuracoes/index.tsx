...
export function Configuracoes() {
  ...
  const [info, setInfo] = useState<InfoAluno>();
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        ...
        <View style={styles.userInfo}>
          ...
          <TextInput style={styles.textConfig}>{user?.nome}</TextInput>

          <LabelText title="Email" color={color} />
          <TextInput style={styles.textConfig}>{user?.email}</TextInput>

          <LabelText title="Senha" color={color} />
          <TextInput style={styles.textConfig}>{"**********"}</TextInput>
          ...
          <Text style={styles.textConfig}>Em breve</Text>
        </View>
      </ScrollView>
    </View>
  );
